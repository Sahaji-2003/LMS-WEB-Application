...
//     questions: [
//       { text: 'Sample Question 1', type: 'single', options: [{ text: 'Option 1' }, { text: 'Option 2' }] },
//       { text: 'Sample Question 2', type: 'multiple', options: [{ text: 'Option 1' }, { text: 'Option 2' }] },
//       { text: 'Sample Question 3', type: 'truefalse' },
//     ],
//   });
...
//       <PaperPreview
//         paper={paper}
//         onEditQuestion={(index) => console.log('Edit question', index)}
//         onDeleteQuestion={(index) => console.log('Delete question', index)}
//         onSaveQuestion={handleSaveQuestion} // Ensure this prop is correctly passed
//       />
//     </div>
//   );
// };
